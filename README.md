...
| `pop()`<br>`Удалить()` | Удаляет и возвращает элемент с вершины стека. Бросает исключение, если стек пуст |
| `peek()`<br>`Прочитать()` | Возвращает элемент с вершины стека, не удаляя его. Бросает исключение, если стек пуст |
