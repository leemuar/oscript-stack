...
Функция ПолучитьСписокТестов(ТестПриложение) Экспорт
	...
	// TODO test pop() behavior: generate exception on stack underflow with a certain exception message
	...
	// TODO test peek() behavior: generate exception on stack underflow with a certain exception message
